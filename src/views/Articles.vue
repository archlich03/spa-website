...
onMounted(() => {
    ...
    if (descriptionMetaTag) {
        descriptionMetaTag.setAttribute('content', "This pages is made to show my latest projects with various technologies. I use this text as a reference. Click on each one to see more details.");
    }
...
<template>
    <Header>
        ...
        <p>
            This pages is made to show my latest projects with various technologies. I use this text as a reference. Click on each one to see more details.
        </p>
